...
@section('content')
    <div class="container mt-5">
        <a class="btn btn-sm btn-primary " style="margin-left: 20px; margin-right: 1000px;" href="{{ route('tiswl.defect_pass_rate') }}">Back</a>
        ...
        <div class="card mt-3">
            ...
            <h6 style="text-align: center">That's It Sportswear Limited</h6>
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Audit Failed Result</th>
