                ...
                <table class="table table-bordered">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('tiswl.defect_rate.third_party') }}">Defect Rate</a></th>
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('tiswl.top-defect') }}">Top Defects</a></th>
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('tiswl.defect_pass_rate') }}">RFT</a></th>
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('tiswl.audit_pass') }}">Shipment Audit</a></th>
