                ...
                <table class="table table-bordered">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('rgl.defect_rate.third_party') }}">Defect Rate</a></th>
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('rgl.top-defect') }}">Top Defects</a></th>
