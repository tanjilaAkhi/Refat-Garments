...
@section('content')
    <div class="container mt-5">
        <a class="btn btn-sm btn-primary " style="margin-left: 20px; margin-right: 1000px;" href="{{ route('ccl.index') }}">Back</a>
        ...
        <div class="card mt-3">
            <h4 style="text-align: center">Creative Collection Limited</h4>
