                ...
                <table class="table table-bordered">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('ccl.defect_rate.third_party') }}">Defect Rate</a></th>
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('ccl.top-defect') }}">Top Defects</a></th>
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('ccl.defect_pass_rate') }}">RFT</a></th>
                            <th scope="col"><a class="btn btn-sm btn-primary" href="{{ route('ccl.audit_pass') }}">Shipment Audit</a></th>
